export const en = {
  ...
  onboarding: {
    ...
    cameraNote: 'Camera access is used to scan your prescriptions. You can change this anytime in Settings.',
    setUp: 'Set up Nusxa',
  ...
  settings: {
    ...
    notifPermAskAgain: 'Reminders stay off until notification access is allowed.',
    notifPermBlocked: 'Notifications are blocked for Nusxa. Allow them in device settings.',
  ...
  scanner: {
    ...
    pagesAdded: '{count} of {max} pages added',
