export const en = {
  ...
  settings: {
    ...
    snoozeDurationDesc: 'Minutes a reminder snoozes for (tap Snooze on Home)',
    aiService: 'AI Service',
    aiServiceDesc: 'Nusxa uses Google Gemini (free tier) to scan and read your prescriptions.',
    openRouterServiceDesc: 'Nusxa uses Nemotron 3 Ultra (free, via OpenRouter) to power the chat companion and medicine explanations.',
    groqServiceDesc: 'Optional fallback: if Nemotron\'s free daily quota runs out, Nusxa switches to Groq (free, much higher daily limit) automatically.',
